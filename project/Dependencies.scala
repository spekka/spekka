...
object Dependencies {
  ...
  lazy val `akka-cluster-sharding` = "com.typesafe.akka" %% "akka-cluster-sharding-typed" % AkkaVersion

  lazy val `akka-stream-testkit` = "com.typesafe.akka" %% "akka-stream-testkit" % AkkaVersion
  lazy val `akka-persistence-testkit` = "com.typesafe.akka" %% "akka-persistence-testkit" % AkkaVersion
